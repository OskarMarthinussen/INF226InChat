...
public final class Channel {
    ...
    public final ArrayList<Pair<Account, String>> members;
    ...
    public void addMember(Account account, String permission) {
        Pair<Account, String> member = new Pair<Account,String>(account, permission);
        members.add(member);
    } 
    /**
